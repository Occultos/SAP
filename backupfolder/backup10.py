...
#==============================================================================================
    ...
    # if pbkdf2_sha256.verify(self.password_info, tokens[1]):
...
#================================================================================================
    def print_dict(self, d):
        ...
        low_line = ""
        current_inventory = ""
        printlocaltime = time.localtime(time.time())
        monthday = str(printlocaltime.tm_mon) + "/" + str(printlocaltime.tm_mday) + "_"
...
#===============================================================================================
    ...
    def login_verify(self):
        ...
        # TODO: remove next few lines when ready to deploy
        self.clear_verify()
        self.clear_login_screen()
        self.user_screen()
        #self.admin_screen()
